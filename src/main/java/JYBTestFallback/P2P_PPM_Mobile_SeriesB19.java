...
public class P2P_PPM_Mobile_SeriesB19 {
	
	private static RunUnit_Service runService;
		
	@BeforeTest
	public void stup() throws Exception{
		Test_Unit testunit = TestXmlParse_Service.parse("src/main/java/JYBTestFallback/P2P_PPM_Mobile_SeriesB19.xml");
		runService = new RunUnit_Service(testunit);
		System.out.println("-----------------------------------【P2P_PPM模式下兜底(十九)用户购买手机系列B产品的测试场景点】-----------------------------------");
	}
