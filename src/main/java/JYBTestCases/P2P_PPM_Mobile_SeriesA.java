...
public class P2P_PPM_Mobile_SeriesA {
	
	private static RunUnit_Service runService;
		
	@BeforeTest
	private void stup() throws Exception{
		Test_Unit testunit = TestXmlParse_Service.parse("src/main/java/JYBTestCaseXml/P2P_PPM_Mobile_SeriesA.xml");
		runService = new RunUnit_Service(testunit);
		System.out.println("-----------------------------------【P2P_PPM模式下用户购买手机系列A产品的测试场景点】-----------------------------------");
	}
