 ...
 * @since   1.0
 */
public class SlideAction_Handler {
     ...
     * @throws Exception
     */
    public void slideLeft(Test_Step step) throws Exception{
    	//滑动起始点与滑动幅度
     ...
     * @throws Exception
     */
    public void slideRight(Test_Step step) throws Exception{
    	//向右滑动的起点与终点坐标
    	System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
     ...
     * @throws Exception 
     */
    public void slideUp(Test_Step step) throws Exception{
    	System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
    	//向上滑动的起点与终点坐标
     ...
     * @throws Exception 
     */
    public void slideDown(Test_Step step) throws Exception{
    	//向下滑动的起点与终点坐标
    	System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
     ...
     * @throws Exception 
     */
    public void slide(Test_Step step) throws Exception{
    	System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
    	commonSlide(step); 
    	Thread.sleep(500);
    }
     ...
     * @throws Exception 
     */
    private void commonSlide(Test_Step step,int direct) throws Exception {
    	AndroidDriver<WebElement> driver = step.getDriver();
     ...
     * @throws Exception
     */
    private void commonSlide(Test_Step step,double[] cor) throws Exception{
    	AndroidDriver<WebElement> driver = step.getDriver();
        int width = driver.manage().window().getSize().width;
        int height = driver.manage().window().getSize().height;
     ...
     * @throws Exception
     */
    private void commonSlide(Test_Step step) throws Exception{
    	AndroidDriver<WebElement> driver = step.getDriver();
        int width = driver.manage().window().getSize().width;
        int height = driver.manage().window().getSize().height;
