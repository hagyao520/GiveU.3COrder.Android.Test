...
public class CheckAction_Handler {
	 ...
	 * @throws Exception 
	 */
	public void check(Test_Step step) throws Exception{
	...
	public void checkView(Test_Step step) throws Exception{
		String Actual = Appium_Util.getElement(step).getAttribute("name");
		String Expected = Appium_Util.parseStringHasEls(step.getValue());
		String FailHint = step.getMessage();
		String FailedScreenshotCaseName = step.getScreenshot();
		System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
	...
	public void checkList(Test_Step step) throws NumberFormatException, Exception{
		System.out.println("『正常测试』开始执行: " + "<" +step.getDesc() + ">");
	...
	public void listSizeNotZero(Test_Step step) throws Exception{
	 ...
	 * @throws Exception
	 */
	public void fieldEquals(Test_Step step) throws NumberFormatException, Exception{
	...
	public void checkEquals(String Actual,String Expected,String FailHint,String FailedScreenshotCaseName){
		try {
			...
			Thread.sleep(500);
 	    	...
 	    	TestXmlParse_Service.screenShot(FailedScreenshotCaseName);
 	    	Assert.fail(FailHint +"  "+"Actual 【"+ Actual +"】"+"  "+"but found 【"+ Expected +"】");
 	    }
	}
}
